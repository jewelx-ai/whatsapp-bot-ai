...
// Customer-facing navigation only. Administration (team roles, plans,
// suspension) belongs to the operator portal at /admin, which has its own
// sign-in and is deliberately not linked or referenced from here.
const navigationGroups = [
  {
    ...
    links: [
      ...
      { href: "/auto-replies", label: "Auto-replies", icon: "bot" },
    ...
    >
      <div className="mb-3 flex items-center gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <span className="badge-accent mt-1 capitalize">
...
export function MobileNavigation({
  ...
  const pathname = usePathname();
  const sectionLabel = currentRouteLabel(pathname) ?? "Workspace";
